...
func Run() error {
	...
	)
	{
		...
		auth.GET("backups", controller.GetBackups)
		auth.POST("backup", controller.PostBackup)
		auth.GET("backupDownload", controller.GetBackupDownload)
		auth.GET("webdavBackups", controller.GetWebdavBackups)
		auth.POST("webdavBackup", controller.PostWebdavBackup)
		auth.GET("webdavBackupDownload", controller.GetWebdavBackupDownload)
		auth.POST("backupRestore", controller.PostBackupRestore)
		auth.GET("diagnose", controller.GetDiagnose)
		auth.GET("notices", controller.GetNotices)
		auth.POST("noticesRead", controller.PostNoticesRead)
