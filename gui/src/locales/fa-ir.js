export default {
  ...
  traffic: {
    ...
    download: "دانلود",
    total: "مجموع",
    realtime: "۶۰ ثانیه اخیر",
    live: "زنده",
    now: "اکنون",
    secondsAgo: "{seconds} ثانیه قبل",
    chartLabel: "سرعت آپلود و دانلود در ۶۰ ثانیه اخیر",
    note: "ترافیک پردازش‌شده توسط هسته v2rayA، با به‌روزرسانی هر ثانیه.",
  },
  operations: {
    name: "عملیات",
    update: "بروزرسانی",
