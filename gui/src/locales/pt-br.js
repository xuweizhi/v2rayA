export default {
  ...
  traffic: {
    ...
    download: "Download",
    total: "Total",
    realtime: "Últimos 60 segundos",
    live: "Ao vivo",
    now: "Agora",
    secondsAgo: "Há {seconds}s",
    chartLabel: "Velocidade de upload e download nos últimos 60 segundos",
    note: "Tráfego processado pelo núcleo v2rayA, atualizado uma vez por segundo.",
  },
  operations: {
    name: "Operações",
    update: "Atualizar",
