export default {
  common: {
    ...
    setting: "Настройки",
    about: "О программе",
    loggedAs: "Текущий логин: {username}",
  ...
  traffic: {
    ...
    download: "Загрузка",
    total: "Всего",
    realtime: "Последние 60 секунд",
    live: "В реальном времени",
    now: "Сейчас",
    secondsAgo: "{seconds} с назад",
    chartLabel: "Скорость отправки и загрузки за последние 60 секунд",
    note: "Трафик, обработанный ядром v2rayA; обновляется раз в секунду.",
  },
  operations: {
    name: "Операции",
    update: "Обновить",
  ...
  proxyGroup: {
    ...
    pickMessage: "Выберите группу прокси для этого узла.",
    group: "Группа прокси",
  ...
  driver: {
    welcome: [
      "Импортируйте первый сервер",
      "Серверов пока нет. Импортируйте или создайте сервер здесь.",
    ],
    tabs: [
      "Подписки и серверы",
      "Здесь можно переключать и управлять подписками, отдельными серверами и серверами подписок.",
    ],
  },
  log: {
