export default {
  ...
  subscription: {
    ...
    userAgentAppend: "Append v2rayA UA",
    xhwid: "X-HWID",
    downloadStrategy: "Download Strategy",
    strategyFollowSystem: "Follow system",
    strategyPreferProxy: "Prefer proxy",
    strategyPreferDirect: "Prefer direct",
    strategyOnlyProxy: "Only proxy",
    strategyOnlyDirect: "Only direct",
    includeRegex: "Include Regex",
    excludeRegex: "Exclude Regex",
    updateIntervalHour: "Update Interval (hours, 0 = global)",
  },
  detectRule: {
    domain: "Domain",
    port: "Port",
  ...
  backup: {
    ...
    time: "Time",
    restore: "Restore",
    restoreConfirm: "The database will be replaced with this backup and the service will restart. The current database is preserved as a safety copy. Continue?",
    restoring: "Restoring... the service will restart shortly",
    webdavUrl: "WebDAV URL",
    webdavUsername: "Username",
    webdavPassword: "Password",
    webdavConnectionMode: "Connection route",
    connectionModes: {
      followSubscription: "Follow subscription route",
      onlyDirect: "Direct only",
      onlyProxy: "Proxy only",
      preferDirect: "Prefer direct, then proxy",
      preferProxy: "Prefer proxy, then direct",
    },
    saveWebdav: "Save WebDAV Config",
  ...
  traffic: {
    ...
    download: "Download",
    total: "Total",
    realtime: "Last 60 seconds",
    live: "Live",
    now: "Now",
    secondsAgo: "{seconds}s ago",
    chartLabel: "Upload and download speed over the last 60 seconds",
    note: "Traffic handled by the v2rayA core, updated once per second.",
  },
  operations: {
    name: "Operations",
  ...
  setting: {
    ...
    noviceModeDesc: "Hide advanced settings for a simpler experience",
