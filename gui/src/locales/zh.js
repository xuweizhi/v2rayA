export default {
  ...
  subscription: {
    ...
    userAgentAppend: "追加 v2rayA UA",
    xhwid: "X-HWID",
    downloadStrategy: "下载策略",
    strategyFollowSystem: "跟随系统",
    strategyPreferProxy: "优先代理",
    strategyPreferDirect: "优先直连",
    strategyOnlyProxy: "仅代理",
    strategyOnlyDirect: "仅直连",
    includeRegex: "包含正则",
    excludeRegex: "排除正则",
    updateIntervalHour: "更新间隔（小时，0 为全局）",
  },
  detectRule: {
    domain: "域名",
    port: "端口",
  ...
  backup: {
    ...
    time: "时间",
    restore: "恢复",
    restoreConfirm: "将用此备份替换数据库并重启服务，当前数据库会保留为安全副本。是否继续？",
    restoring: "正在恢复…服务即将重启",
    webdavUrl: "WebDAV 地址",
    webdavUsername: "用户名",
    webdavPassword: "密码",
    webdavConnectionMode: "连接路径",
    connectionModes: {
      followSubscription: "沿用订阅下载路径",
      onlyDirect: "仅直连",
      onlyProxy: "仅代理",
      preferDirect: "优先直连，失败后代理",
      preferProxy: "优先代理，失败后直连",
    },
    saveWebdav: "保存 WebDAV 配置",
    uploadLatest: "上传最新备份",
    refreshRemote: "刷新",
    remoteFiles: "远端文件",
  },
  ...
  traffic: {
    ...
    chartLabel: "最近 60 秒上传和下载速度图",
    note: "统计 v2rayA core 处理的流量，每秒更新一次。",
  },
  operations: {
